...
def main():
    ...
    precisionTestMicro = PrecisionTest(test_name="Precision Test Micro", startPosn=10, endPosn=10.005, precision=0.00025)
    precisionTestMicroResult = precisionTestMicro.execute(motor=1, encoder=9)
    print(precisionTestMicroResult)

    precisionTestMacro = PrecisionTest(test_name="Precision Test Macro", startPosn=10, endPosn=20, precision=0.00025)
    precisionTestMacroResult = precisionTestMacro.execute(motor=1, encoder=9)
    print(precisionTestMacroResult)

    precisionTestMicroLarge = PrecisionTest(test_name="Precision Test Micro Large", startPosn=10, endPosn=20.005, precision=0.00025)
