...
def main():
    ...
    try:
        ...
        velocityTestFastResult = velocityTestFast.execute(motor, encoder)
        #print(velocityTestFastResult)
        results.append(velocityTestFastResult)

        ReportGenerator(results).generate_report("motion_control_report.txt")
